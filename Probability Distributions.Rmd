...
normd.d = rnorm(1000)
normd.e = rnorm(1000)
chi.sq.5 <- (normd.a)^2 + (normd.b)^2 + (normd.c)^2 + (normd.d)^2 + (normd.e)^2
hist(chi.sq.5)

scaled.chi.sq.5 = chi.sq.5 / 5 

normd.f <- rnorm( n=1000 )                # yet another #set of normally distributed data
t.5 <- normd.f / sqrt( scaled.chi.sq.5 )  # divide by #square root of scaled chi-square to get t
hist(t.5)
